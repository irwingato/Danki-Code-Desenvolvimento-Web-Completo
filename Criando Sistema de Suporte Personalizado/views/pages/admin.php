<?php
	...
	if(isset($_POST['responder_novo_chamado'])){
		...
		try {
		    ...
		    $mail->Subject = 'Nova interação do chamado: '.$token;
		    $url = BASE.'chamado?token='.$token;
		    $informacoes = '
		    Uma nova interação foi feita no seu chamado!<br />Utilize o link abaixo para interagir:<br /><a href="'.$url.'">Acessar chamado!</a>
		    ';
...
?>
	...
	<p>Clique<a href="<?php echo BASE ?>chamado?token=<?php echo $value['id_chamado']; ?>"> aqui</a> para visuallizar este chamado!</p>
	<form method="post">
		<textarea name="mensagem" placeholder="Sua resposta"></textarea>
		<br />
		<br />
