<div class="box-content">
	<h2><i class="fa-solid fa-address-card" aria-hidden="true"></i> Clientes Cadastrados</h2>
	<div class="busca">
	...
	<?php
		...
		$clientes = MySql::conectar()->prepare("SELECT * FROM `tb_admin_clientes` $query");
		$clientes->execute();
	...
	?>
		<div class="box-single-wraper">
			<div class="box-single">
				...
				<div class="body-box">
					<p><b><i class="fa-solid fa-circle-info"></i> Nome do cliente: </b><?php echo $value['nome'] ?></p>
					<p><b><i class="fa-solid fa-circle-info"></i> E-mail: </b> <?php echo $value['email'] ?></p>
					<p><b><i class="fa-solid fa-circle-info"></i> Tipo: </b> <?php echo ucfirst($value['tipo']) ?></p>
					<p><b><i class="fa-solid fa-circle-info"></i> <?php
