...
<div class="box">
	...
	?>
	<h2><i class="fa-solid fa-money-check-dollar"></i> Pagamentos <?php echo $nome; ?></h2>
	<div class="gerar-pdf">
		<a href="<?php echo INCLUDE_PATH_PAINEL ?>gerar-pdf.php?pagamento=concluidos" target="_blank"></a>
	</div>
		...
		<table>
			...
			<?php
				if($nome  == 'Pendentes')
					...
					$nome = 1;
				$sql = MySql::conectar()->prepare("SELECT * FROM `tb_admin_financeiro` WHERE status = $nome ORDER BY vencimento ASC");
				$sql->execute();
