...
<head>
	...
	<link rel="stylesheet" href="<?php echo INCLUDE_PATH_PAINEL ?>css/jquery-ui.min.css" rel="stylesheet" />
...
<header>
	<div class="center">
		...
		<div class="loggout">
			<a <?php if(@$_GET['url'] == 'calendario'){ ?> style="background: #60727a;padding: 15px;" <?php } ?> href="<?php echo INCLUDE_PATH_PAINEL ?>calendario"><i class="fa-solid fa-calendar"></i> <span>Calendário</span></a>

			<a <?php if(@$_GET['url'] == 'chat'){ ?> style="background: #60727a;padding: 15px;" <?php } ?> href="<?php echo INCLUDE_PATH_PAINEL ?>chat"><i class="fa-solid fa-comment"></i> <span>Chat Online</span></a>
