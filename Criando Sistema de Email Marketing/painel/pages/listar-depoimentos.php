...
<div class="box-content">
	<h2><i class="fa-solid fa-circle-info"></i> Depoimentos Cadastrados</h2>
	<div class="wraper-table">
		<table>
			...
			<tr>
				...
				<td><a class="btn edit" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-depoimento?id=<?php echo $value['id']; ?>"><i class="fa-solid fa-pen"></i> Editar</a></td>
