<div class="box-content">
	<?php
		if(isset($_POST['acao'])){
			...
			$sql = \MySql::conectar()->prepare("INSERT INTO `tb_admin_listas_email` VALUES(null,?)");
			$sql->execute(array($nome_lista));
			Painel::alert('sucesso','A lista foi criada com sucesso!');
		}
	?>

	<h2><i class="fa-solid fa-pen"></i> Adicionar nova Lista</h2>	
	...
	<h2><i class="fa fa-pencial"></i> Listas Disponíveis</h2>
