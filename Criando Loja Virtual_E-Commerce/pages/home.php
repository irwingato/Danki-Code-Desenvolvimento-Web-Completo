	...
	<div class="container">
		<?php
			...
			foreach($items as $key =>$value){
				$imagem = \MySql::conectar()->prepare("SELECT * FROM `tb_admin_estoque_imagens` WHERE produto_id = $value[id]");
				$imagem->execute();
		...
		<div class="produto-single-box">
			...
			<a href="<?php echo INCLUDE_PATH ?>?addCart=10"> Adicionar no carrinho!</a>		
