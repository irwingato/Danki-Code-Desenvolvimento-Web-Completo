	...
	<?php
		...
		<?php
			...
			if(isset($_POST['postar_comentario'])){
				...
				$sql = MySql::conectar()->prepare("INSERT INTO `tb_site_comentarios` VALUES (null,?,?,?)");
		...
		<?php
			$comentarios = MySql::conectar()->prepare("SELECT * FROM `tb_site_comentarios` WHERE noticia_id = ?");
