...
<body>
		...
		if(isset($_POST['acao'])){
			...
			if(preg_match('/[0-9]{10,11}/', $numero)){
				if(preg_match('/[a-z0-9]{1,255}/', $body)){
					...
					$sid = 'AC1d34e8c0b0f9455d8cfc891cd7e7f564';
					$token = '850869f177cca1ecb18fd608ee83a25b';
					...
					echo 'A mensagem foi enviado com sucesso!';
				}else{
	...
	<section class="contato">
		<form method="post">
			...
			<textarea placeholder="Seu SMS..." name="body"></textarea>
