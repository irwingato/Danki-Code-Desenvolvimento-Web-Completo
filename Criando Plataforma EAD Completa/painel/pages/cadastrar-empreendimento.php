<div class="box-content">
	<h2><i class="fa fa-pen"></i> Cadastrar Empreendimento</h2>
			...
			if(isset($_POST['acao'])){
				...
				if($_FILES['imagem']['name'] == ''){
					...
					if(!(Painel::imagemValida($imagem))){
						...
						$sql = MySql::conectar()->prepare("INSERT INTO `tb_admin_empreendimentos` VALUES (null,?,?,?,?,?,?)");
						$sql->execute(array($nome,$tipo,$preco,$idImagem,$slug,0));
						$lastId = MySql::conectar()->lastInsertId();
						MySql::conectar()->exec("UPDATE `tb_admin_empreendimentos` SET order_id = $lastId WHERE id = $lastId");
